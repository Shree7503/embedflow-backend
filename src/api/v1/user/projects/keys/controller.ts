...
export const createKey = async (req: KeyRequest, res: Response, next: NextFunction) => {
...
export const listKeys = async (req: KeyRequest, res: Response, next: NextFunction) => {
    const userId = req.user.id;
    const { projectId } = req.params;
...
export const revokeKey = async (req: KeyRequest, res: Response, next: NextFunction) => {
    const userId = req.user.id;
